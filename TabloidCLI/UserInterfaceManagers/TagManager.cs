...
namespace TabloidCLI.UserInterfaceManagers
{
    public class TagManager : IUserInterfaceManager
    {
        ...
        private TagRepository _tagRepository; // added this
        private string _connectionString; // added this

        public TagManager(IUserInterfaceManager parentUI, string connectionString)
        {
            _parentUI = parentUI;
            _tagRepository = new TagRepository(connectionString);// added this
            _connectionString = connectionString;// added this
        }
        ...
        //added Choose for Edit function
