...
namespace TabloidCLI.UserInterfaceManagers
{
    internal class PostDetailManager : IUserInterfaceManager
    {
        ...
        private string _connectionString; // Added this field
        private int _postId;
        ...
        public PostDetailManager(IUserInterfaceManager parentUI, string connectionString, int postId)
        {
            ...
            _connectionString = connectionString; // Assigned the connection string
            _postId = postId;
        }
        ...
        public IUserInterfaceManager Execute()
        {
            ...
            switch (choice)
            {
                ...
                case "3":
                    ...
                    return this;
                case "4":
                    // Used _connectionString to instantiate NoteManager
